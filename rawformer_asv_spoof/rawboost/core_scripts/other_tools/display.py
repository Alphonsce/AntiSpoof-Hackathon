...
def f_print(message, opt="ok", end="\n", flush=False):
    ...
    if opt == "warning":
        print(
            DisplayColors.WARNING + str(message) + DisplayColors.ENDC,
            flush=flush,
            end=end,
        )
    elif opt == "highlight":
        print(
            DisplayColors.OKGREEN + str(message) + DisplayColors.ENDC,
            flush=flush,
            end=end,
        )
    elif opt == "ok":
        print(
            DisplayColors.OKBLUE + str(message) + DisplayColors.ENDC,
            flush=flush,
            end=end,
        )
    elif opt == "error":
        print(
            DisplayColors.FAIL + str(message) + DisplayColors.ENDC, flush=flush, end=end
        )
    else:
...
def f_print_w_date(message, level="h"):
    ...
    if level == "h":
        ...
        f_print(
            "---" + str(message) + " " + str(datetime.datetime.now().time()) + "---"
        )
    else:
