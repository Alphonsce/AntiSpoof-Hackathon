...
class ConfigPA:
    ...
    def __init__(self):
        ...
        # hidden subset 1
        self.hidden = {
            "hidden1_PA": 'trim == "notrim" and subset == "hidden"',
        ...
        self.factor_1_type = [
            g_factor_type_both,
            g_factor_type_both,
            g_factor_type_bonafide,
            g_factor_type_both,
        ]
        # string of factors to be printed
        self.factor_1_tag_list = [
            item for sublist in self.factor_1_list for item in sublist
        ]
        ...
        self.factor_2_tag_list = [
            item for sublist in self.factor_2_list for item in sublist
        ]
...
class ConfigDF:
    ...
    def __init__(self):
        ...
        # =====
        # C012 buffer
        self.c012_file = {"eval": "", "progress": "", "hidden": ""}
