...
def winfuns(*args):
    ...
    if name in {"Hann", "hann", "nuttall10", "Nuttall10"}:
        ...
        g = (
            0.35875
            + 0.48829 * np.cos(2 * np.pi * x)
            + 0.14128 * np.cos(4 * np.pi * x)
            + 0.01168 * np.cos(6 * np.pi * x)
        )
    elif name in {"modblackharr", "Modblackharr"}:
        g = (
            0.35872
            + 0.48832 * np.cos(2 * np.pi * x)
            + 0.14128 * np.cos(4 * np.pi * x)
            + 0.01168 * np.cos(6 * np.pi * x)
        )
        ...
        g = (
            0.355768
            + 0.487396 * np.cos(2 * np.pi * x)
            + 0.144232 * np.cos(4 * np.pi * x)
            + 0.012604 * np.cos(6 * np.pi * x)
        )
        ...
        g = (
            0.4243801
            + 0.4973406 * np.cos(2 * np.pi * x)
            + 0.0782793 * np.cos(4 * np.pi * x)
        )
    elif name in {"nuttall30", "Nuttall30"}:
        g = (
            10 / 32
            + 15 / 32 * np.cos(2 * np.pi * x)
            + 6 / 32 * np.cos(4 * np.pi * x)
            + 0.1 / 32 * np.cos(6 * np.pi * x)
        )
    elif name in {"nuttall21", "Nuttall21"}:
        g = (
            0.338946
            + 0.481973 * np.cos(2 * np.pi * x)
            + 0.161054 * np.cos(4 * np.pi * x)
            + 0.018027 * np.cos(6 * np.pi * x)
        )
