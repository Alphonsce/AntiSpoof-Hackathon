...
train_folders = [
    db_folder + "PA/ASVspoof2019_PA_train/flac/"
]  # [db_folder + 'PA/ASVspoof2019_PA_train/flac/', db_folder + 'PA/ASVspoof2019_PA_dev/flac/']
train_keys = [
    db_folder + "PA/ASVspoof2019_PA_cm_protocols/ASVspoof2019.PA.cm.train.trn.txt"
]  # [db_folder + 'PA/ASVspoof2019_PA_cm_protocols/ASVspoof2019.PA.cm.train.trn.txt', db_folder + 'PA/ASVspoof2019_PA_cm_protocols/ASVspoof2019.PA.cm.dev.trn.txt']
