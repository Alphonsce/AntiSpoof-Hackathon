        ...
        for idx1, attack in enumerate(attack_list):
            ...
            if len(bon_scores) and len(spf_scores):
                ...
                minDCF, eer, cllr, actDCF = calculate_minDCF_EER_CLLR_actDCF(
                    cm_scores=cm_scores, cm_keys=cm_keys, output_file="", printout=False
                )
...
def calculate_aDCF_tdcf_tEER_full(
    sasv_score_key_pd, asv_org_score_key_pd, flag_sasv_only=False
):
    """
