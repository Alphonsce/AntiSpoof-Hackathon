...
def f_args_parsed(argument_input=None):
    ...
    parser.add_argument("--module-config", type=str, default="config", help=mes)
    ...
    parser.add_argument("--grad-clip-norm", type=float, default=-1.0, help=mes)
    ...
    parser.add_argument(
        "--eval-mode-for-validation", action="store_true", default=False, help=mes
    )
    ...
    parser.add_argument(
        "--model-forward-with-target", action="store_true", default=False, help=mes
    )
    ...
    mes += "model.forward(input, target, file_name) should be defined"
    parser.add_argument(
        "--model-forward-with-file-name", action="store_true", default=False, help=mes
    )
    ...
    parser.add_argument(
        "--multi-gpu-data-parallel", action="store_true", default=False, help=mes
    )
    ...
    parser.add_argument(
        "--way-to-merge-datasets", type=str, default="concatenate", help=mes
    )
    ######
    ...
    parser.add_argument(
        "--not-save-each-epoch", action="store_true", default=False, help=mes
    )
    ...
    parser.add_argument(
        "--save-trained-name", type=str, default="trained_network", help=mes
    )
    ...
    parser.add_argument(
        "--trained-model", type=str, default="", help=mes + "(default: '')"
    )
    ...
    mes = mes + " (default: 1)"
    parser.add_argument("--verbose", type=int, default=1, help=mes)
    ...
    parser.add_argument("--opt-wav-silence-handler", type=int, default=0, help=mes)
