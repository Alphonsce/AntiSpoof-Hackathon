...
def main():
    ...
    parser.add_argument(
        "--inputs", nargs="+", default=["-"], help="input files to filter"
    )
    parser.add_argument(
        "--langs", nargs="+", required=True, help="lang ids of each input file"
    )
    parser.add_argument(
        "--outputs", nargs="+", default=["-"], help="path to save lid filtered outputs"
    )
    parser.add_argument(
        "--num-workers",
        type=int,
